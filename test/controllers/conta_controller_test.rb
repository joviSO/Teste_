...
class ContaControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create contum" do
    assert_difference('Contum.count') do
      post conta_url, params: { contum: { nomeDaConta: @contum.nomeDaConta, userId: @contum.userId } }
    end
  ...
  test "should update contum" do
    patch contum_url(@contum), params: { contum: { nomeDaConta: @contum.nomeDaConta, userId: @contum.userId } }
